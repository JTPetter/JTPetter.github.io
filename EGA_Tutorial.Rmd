...
to common methods of exploratory factor analysis. EGA is based on the insight that latent variables are reflected as clusters in network models. **TODO: longer introduction**
...
Alternatively, we can look at the scree plot and eigenvalues to determine the number of factors. For this we can use the *scree* function from the *psych* package.
...
The Kaiser criterion recommends to drop all factors with an eigenvalue < 1. From this analysis we would thus conclude that a 1-factor structure is appropriate for the data. **TODO: Maybe some interpretation on why this differs**
